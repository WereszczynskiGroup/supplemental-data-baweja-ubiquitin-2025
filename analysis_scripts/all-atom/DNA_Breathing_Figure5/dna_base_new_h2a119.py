...
for i in range(1, 4):
    new_directory = "/home/lbaweja/H2A119_corrected_sim" + str(i)
    os.chdir(new_directory)
    
    u = mda.Universe('h2a_sim' + str(i) + ".pdb", "h2a119_final_sim" + str(i) + ".xtc")
    
    H3_1_2 = "resid 86:114 or resid 652:680"  # H3 residues for nucleosome axis
    ...
    with open('dimer1_h2a.unwrap_'+'side1_sim'+str(i), 'w') as f:
    ...
    with open('dimer1_h2a.unwrap_'+'side2_sim'+str(i), 'w') as f:
        for ts in u.trajectory[::100]:
            wrapped_bp_count = 0
            total_bp = len(strand1_residues)
